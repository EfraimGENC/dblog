    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', imagekit.models.fields.ProcessedImageField(default='', upload_to=apps.account.models.Profile.handle_avatar_file, verbose_name='Profile Picture')),
                ...
                ('language', models.CharField(choices=[('tr-tr', 'Turkish'), ('en-us', 'English')], default='tr-tr', max_length=10)),
